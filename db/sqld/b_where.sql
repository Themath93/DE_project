...
select emp_name, salary*12 as 연봉 from employee where salary >= 4000000;
...
select *
from employee
where dept_code ='D5' and emp_name like '%이%';
...
--employee 테이블에서 전화번호의 4번째 자리부터 9로 시작하는 사원의 사번, 이름, 전화번호를 지정
select emp_id, emp_name, phone 
from employee
--where phone like '___9%'; 4번째자리부터 9로 시작
where phone like '%9___'; -- 마지막부터 4번째 부터 9로시작
